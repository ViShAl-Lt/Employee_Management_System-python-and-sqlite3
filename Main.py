...
addButton = Button(buttonFrame ,  command = addEntry , text="Add Entry"  ,width=15 , font=("Segoe", 15 , "bold") , bg ="green" , fg="#fff").grid(row = 1 ,  column= 1, padx=45 )


updateButton = Button(buttonFrame ,  command = updateEntry , text="Update Entry"  ,width=15 , font=("Segoe", 15 , "bold") , bg ="#555" , fg="#fff").grid(row = 1 ,  column= 2, padx=45 )


deleteButton = Button(buttonFrame ,  command = deleteEntry , text="Delete Entry"  ,width=15 , font=("Segoe", 15 , "bold") , bg ="red" , fg="#fff").grid(row = 1 ,  column= 3 , padx=45 )


clearButton = Button(buttonFrame ,  command = clearAllEntry, text="Clear Entry"  ,width=15 , font=("Segoe", 15 , "bold") , bg ="blue" , fg="#fff").grid(row = 1 ,  column= 4 ,padx=45 )
...
table.place(x = 0 , y = 338 , width = 1558 , height =700)
